...
{
    /// <inheritdoc />
    public partial class ProviderClientPrograms : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Distance = table.Column<decimal>(type: "numeric(8,2)", nullable: true),
                    ...
                    ProviderFeedback = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    CompletedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    SortOrder = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AssignedProgramTasks", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProviderFeedback = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProgramTemplateDays", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsPublicTemplate = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProgramTemplateTasks", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssignedPrograms_ClientUserId_Status",
                schema: "within",
                table: "AssignedPrograms",
                columns: new[] { "ClientUserId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_AssignedPrograms_ProgramTemplateId",
                schema: "within",
                table: "AssignedPrograms",
                column: "ProgramTemplateId");

            migrationBuilder.CreateIndex(
                name: "IX_AssignedPrograms_ProviderId_Status",
                schema: "within",
                table: "AssignedPrograms",
                columns: new[] { "ProviderId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_AssignedProgramTasks_AssignedProgramId_ScheduledDate",
                schema: "within",
                table: "AssignedProgramTasks",
                columns: new[] { "AssignedProgramId", "ScheduledDate" });

            migrationBuilder.CreateIndex(
                name: "IX_AssignedProgramTasks_ScheduledDate_Status",
                schema: "within",
                table: "AssignedProgramTasks",
                columns: new[] { "ScheduledDate", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_ClientCheckIns_AssignedProgramId_CheckInDate",
                schema: "within",
                table: "ClientCheckIns",
                columns: new[] { "AssignedProgramId", "CheckInDate" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ClientCheckIns_ClientUserId_CheckInDate",
                schema: "within",
                table: "ClientCheckIns",
                columns: new[] { "ClientUserId", "CheckInDate" });

            migrationBuilder.CreateIndex(
                name: "IX_ClientCheckIns_ProviderId_CheckInDate",
                schema: "within",
                table: "ClientCheckIns",
                columns: new[] { "ProviderId", "CheckInDate" });

            migrationBuilder.CreateIndex(
                name: "IX_ProgramTemplateDays_ProgramTemplateWeekId_DayNumber",
                schema: "within",
                table: "ProgramTemplateDays",
                columns: new[] { "ProgramTemplateWeekId", "DayNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ProgramTemplates_IsPublicTemplate_Category",
                schema: "within",
                table: "ProgramTemplates",
                columns: new[] { "IsPublicTemplate", "Category" });

            migrationBuilder.CreateIndex(
                name: "IX_ProgramTemplates_ProviderId_CreatedAt",
                schema: "within",
                table: "ProgramTemplates",
                columns: new[] { "ProviderId", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_ProgramTemplateTasks_ProgramTemplateDayId_SortOrder",
                schema: "within",
                table: "ProgramTemplateTasks",
                columns: new[] { "ProgramTemplateDayId", "SortOrder" });
