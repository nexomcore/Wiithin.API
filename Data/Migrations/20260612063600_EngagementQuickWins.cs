...
{
    /// <inheritdoc />
    public partial class EngagementQuickWins : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AlterDatabase()
                ...
                .Annotation("Npgsql:Enum:notification_kind", "daily_motivation,event_reminder24h,event_reminder2h,event_updated,community_summary,provider_new_event,friend_request_received,friend_request_accepted,event_invite,public_friend_rsvp,circle_thread_reply,comment_reply,user_mention,event_reminder,circle_join_request,circle_invite,circle_join_approved,program_assigned,program_updated,program_task_due,program_check_in_requested,program_feedback_added,program_completed,provider_new_follower,weekly_progress_summary,streak_at_risk,reengagement_reminder,program_overdue,challenge_reminder")
                .Annotation("Npgsql:Enum:notification_mute_target_type", "circle,event,user")
                .Annotation("Npgsql:Enum:notification_target_type", "event,circle,circle_thread,community_post,profile,connection,comment,program,program_task,program_check_in")
                ...
                .OldAnnotation("Npgsql:Enum:notification_kind", "daily_motivation,event_reminder24h,event_reminder2h,event_updated,community_summary,provider_new_event,friend_request_received,friend_request_accepted,event_invite,public_friend_rsvp,circle_thread_reply,comment_reply,user_mention,event_reminder,circle_join_request,circle_invite,circle_join_approved,program_assigned,program_updated,program_task_due,program_check_in_requested,program_feedback_added,program_completed")
                .OldAnnotation("Npgsql:Enum:notification_mute_target_type", "circle,event,user")
                .OldAnnotation("Npgsql:Enum:notification_target_type", "event,circle,circle_thread,community_post,profile,connection,comment,program,program_task,program_check_in")
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProviderFollows", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "ProviderProfileViews",
                schema: "within",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProviderProfileViews", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_ProviderFollows_ProviderId",
                schema: "within",
                table: "ProviderFollows",
                column: "ProviderId");

            migrationBuilder.CreateIndex(
                name: "IX_ProviderFollows_ProviderId_UserId",
                schema: "within",
                table: "ProviderFollows",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProviderFollows_UserId_CreatedAt",
                schema: "within",
                table: "ProviderFollows",
                columns: new[] { "UserId", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_ProviderProfileViews_ProviderId_ViewDate",
                schema: "within",
                table: "ProviderProfileViews",
                columns: new[] { "ProviderId", "ViewDate" });

            migrationBuilder.CreateIndex(
                name: "IX_ProviderProfileViews_ViewerUserId_ViewedAt",
                schema: "within",
                table: "ProviderProfileViews",
                columns: new[] { "ViewerUserId", "ViewedAt" });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AlterDatabase()
                ...
                .Annotation("Npgsql:Enum:member_list_visibility", "public,members_only,admins_only,hidden")
                .Annotation("Npgsql:Enum:mention_source_type", "event_comment,circle_post,circle_comment")
                .Annotation("Npgsql:Enum:notification_kind", "daily_motivation,event_reminder24h,event_reminder2h,event_updated,community_summary,provider_new_event,friend_request_received,friend_request_accepted,event_invite,public_friend_rsvp,circle_thread_reply,comment_reply,user_mention,event_reminder,circle_join_request,circle_invite,circle_join_approved,program_assigned,program_updated,program_task_due,program_check_in_requested,program_feedback_added,program_completed")
                .Annotation("Npgsql:Enum:notification_mute_target_type", "circle,event,user")
                .Annotation("Npgsql:Enum:notification_target_type", "event,circle,circle_thread,community_post,profile,connection,comment,program,program_task,program_check_in")
                .Annotation("Npgsql:Enum:profile_visibility", "public,friends_only,circle_members_only,private")
                .Annotation("Npgsql:Enum:provider_application_status", "submitted,in_review,more_info_requested,approved,rejected")
                ...
                .OldAnnotation("Npgsql:Enum:member_list_visibility", "public,members_only,admins_only,hidden")
                .OldAnnotation("Npgsql:Enum:mention_source_type", "event_comment,circle_post,circle_comment")
                .OldAnnotation("Npgsql:Enum:notification_kind", "daily_motivation,event_reminder24h,event_reminder2h,event_updated,community_summary,provider_new_event,friend_request_received,friend_request_accepted,event_invite,public_friend_rsvp,circle_thread_reply,comment_reply,user_mention,event_reminder,circle_join_request,circle_invite,circle_join_approved,program_assigned,program_updated,program_task_due,program_check_in_requested,program_feedback_added,program_completed,provider_new_follower,weekly_progress_summary,streak_at_risk,reengagement_reminder,program_overdue,challenge_reminder")
                .OldAnnotation("Npgsql:Enum:notification_mute_target_type", "circle,event,user")
                .OldAnnotation("Npgsql:Enum:notification_target_type", "event,circle,circle_thread,community_post,profile,connection,comment,program,program_task,program_check_in")
                .OldAnnotation("Npgsql:Enum:profile_visibility", "public,friends_only,circle_members_only,private")
                .OldAnnotation("Npgsql:Enum:provider_application_status", "submitted,in_review,more_info_requested,approved,rejected")
